...
plot(1,1,type="n",bty="n",xlab="",ylab="",xaxt="n",yaxt="n",xlim=c(-10,350),ylim=c(0.25,15.25))
abline(h=1:14,col="darkgrey")
points(KNN_varimp_conditional,1:15,pch=19,cex=1.5)
axis(side=1,at=seq(0,350,50),font=2,cex.axis=1.25,lwd=2,lwd.ticks=2)
axis(side=2,at=1:15,las=2,font=2,tick=F,cex.axis=1.25,labels=names(KNN_varimp_conditional))
