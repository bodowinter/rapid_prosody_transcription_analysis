...
mdl.SyllableDur <- glmer(Prominence ~ SyllableDur_z +
...
xmdl.POS_class <- glmer(Prominence ~ POS_class +
...
xmdl.Focused <- glmer(Prominence ~ Focused +
	(1 + Focused|Listener) + 
	(1|Speaker) +
	(1|WordWithinSentence) + (1|Sentence),
	RPT, family = 'binomial')
...
xmdl.argument <- glmer(Prominence ~ LastArgument +
	(1 + LastArgument|Listener) + 
	(1|Speaker) +
	(1|WordWithinSentence) + (1|Sentence),
	RPT, family = 'binomial')
